...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject chest; // asigna aquí el cofre en el inspector de Unity
    ...
    void Update()
    {
        fondo.material.mainTextureOffset = fondo.material.mainTextureOffset + new Vector2(0.0015f, 0) * Time.deltaTime;
    }
